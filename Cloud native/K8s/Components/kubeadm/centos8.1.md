...
* 后面发现是安装docker会与podman有冲突，这个在上面的大段错误信息中也有描述到。
...
```shell
May 28 22:23:40 master01 kubelet[21245]: W0528 22:23:40.356562   21245 watcher.go:87] Error while processing event ("/sys/fs/cgroup/devices/libcontainer_14821_systemd_test_default.slice": 0x40000100 == IN_CREATE|IN_ISDIR): inotify_add_watch /sys/fs/cgroup/devices/libcontainer_14821_systemd_test_default.slice: no such file or directory
May 28 22:23:40 master01 kubelet[21245]: W0528 22:23:40.356579   21245 watcher.go:87] Error while processing event ("/sys/fs/cgroup/pids/libcontainer_14821_systemd_test_default.slice": 0x40000100 == IN_CREATE|IN_ISDIR): inotify_add_watch /sys/fs/cgroup/pids/libcontainer_14821_systemd_test_default.slice: no such file or directory
```
...
[calico异常](https://github.com/projectcalico/calico/issues/2720)
